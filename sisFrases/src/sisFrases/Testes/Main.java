...
public class Main {
	...
	public static void main(String[] args) {
		...
		autor3.setAutorNome("João");
		autorDao3.insere(autor3);
		autor3 = autorDao3.buscaPorId(3);
		
		//Inserir
		Livro livro1 = new Livro();
		livro1.setLivroTitulo("Evagelho de João");
		...
		//Altera livro
		livro2.setLivroTitulo("Revelações ou Apocalipse");
		livroDao.altera(livro2);
		System.out.println("Livro do ID 2 aterado: "+livroDao.buscaPorId(2));
		
		//Deleta autor
		System.out.println("Verificação deleção livro 1"+livroDao.deleta(1));
		...
		frase1.setFraseTexto("Aquele que perseverar até o fim será salvo");
		frase1.setFraseLivro(livro10);
		Frase frase2 = new Frase();
		frase2.setFraseTexto("Eis que faço novas todas as coisas");
		...
		//Busca para Post
		System.out.println(fraseDao.buscaPost(3));
		Frase frasePost = fraseDao.buscaPost(3);
		String frase = frasePost.getFraseTexto();
		String livro = frasePost.getFraseLivro().getLivroTitulo();
		String autorP = frasePost.getFraseLivro().getLivroAutorId().getAutorNome();
		System.out.println("Frase para postar:"+frase+", "+livro+","+autorP);
